...
class Staticman {
  ...
  _initialiseSubscriptions () {
    ...
    const domain = this.siteConfig.get('notifications.domain') || config.get('email.domain')
    const subscriptions = new SubscriptionsManager(this.parameters, this.git, mg, domain)
